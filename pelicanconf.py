...
AUTHOR          = 'Premkumar Gunasekaran'  # use your name
SITENAME        = 'mypythonnotes' # use title
GITHUB_USERNAME = 'apgprem' # use your username
...
SOCIAL = (
    ...
    ("LinkedIn", "https://www.linkedin.com/in/premkumargunasekaran-bengaluru/"),
)
